...
function basculeEcran(sens) {    ;
    ...
    donneesGrille = new (Ext.extend(Ext.data.GroupingStore, new GeoExt.data.FeatureStoreMixin))({
        ...
        proxy: new GeoExt.data.ProtocolProxy({
            protocol: new OpenLayers.Protocol.HTTP({
                url: '../Modeles/GeoJson/gjInfosProprio.php',
    ...
    var filtres = new Ext.ux.grid.GridFilters({
        ...
        filters:[{type: 'numeric', dataIndex: 'gid', menuItemCfgs : {emptyText: ''}},
            ...
            {type: 'numeric', dataIndex: 'surf_ha_geom', menuItemCfgs : {emptyText: ''}}
        ]
    });
    ...
    var configCols = new Ext.MyColumnModel({
        ...
        columns: [
            ...
            {dataIndex: 'gpm_lib', header: 'Statut'},
            {dataIndex: 'surf_ha_geom', header: 'Surf. ha géom.'}
        ]
    });
    //Barre de menu
    ...
    grille = new Ext.grid.GridPanel({
        ...
        id: 'grilleInfosProprio', // unique pour conserver la configuration de la grille
        header: false,
        ds: donneesGrille,
        cm: configCols,
        autoScroll: true,
    ...
    var cartePanel = new GeoExt.MapPanel({
        id: 'carteInfosProprio', // unique pour conserver la configuration de la carte
        map: carte,
        region: sens,
        split: true,
...
function exporterExcel() {
    ...
    types['surf_ha_geom'] = Ext.data.Types.FLOAT;
