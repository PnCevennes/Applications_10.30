<html>
    <head>
        <title>Interface de consultation (connexion)</title>
        <!-- Définition du jeu de caractères -->
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <!-- Bibliothèques Ext en français (version de production) -->
        ...
        <!-- Formulaire -->
        <script type="text/javascript" src="../Controleurs/Formulaires/frmLogin.js"></script>
    </head>
    <body>
    </body>
</html>
