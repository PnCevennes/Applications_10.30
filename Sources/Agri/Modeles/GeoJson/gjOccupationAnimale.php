<?php
    ...
    require_once '../../Modeles/Classes/ClassCnxPgThematique.php';
    require_once '../../../../Outils/FiltreCarte.php';
    require_once '../../../../Outils/FiltreGrille.php';
    $cnxPgThematique = new CnxPgThematique();
    $req = 'SELECT * FROM pasto.v_wm_occupation_animale WHERE ' . $where .
        ' AND ' . $and . $orderLimit;
    $rs = $cnxPgThematique->executeSql($req);
    $rsTot = $cnxPgThematique->executeSql('SELECT COUNT(gid) FROM pasto.v_wm_occupation_animale WHERE ' .
        $where . ' AND ' . $and);
